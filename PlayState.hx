...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(songLowercase)
		{
			...
			case 'senpai' | 'roses' | 'thorns' | 'bedabada' | 'raw' | 'planes' | 'anger':
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			if (SONG.song.toLowerCase() == "anger")
				{
					babyArrow.frames = Paths.getSparrowAtlas('airport/crash_notes');
						for (j in 0...4)
						{
