...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'patrick':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('Adidas_BOI_Sprites','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Adidas BOI idle', 24, false);
				animation.addByPrefix('singUP', 'Adidas BOI up', 24, false);
				animation.addByPrefix('singRIGHT', 'Adidas BOI right', 24, false);
				animation.addByPrefix('singDOWN', 'Adidas BOI down', 24, false);
				animation.addByPrefix('singLEFT', 'Adidas BOI left', 24, false);
			...
			case 'crashrick':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('crashBro','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Crash Bro idle', 24, false);
				animation.addByPrefix('singUP', 'Crash Bro up', 24, false);
				animation.addByPrefix('singRIGHT', 'Crash Bro right', 24, false);
				animation.addByPrefix('singDOWN', 'Crash Bro down', 24, false);
				animation.addByPrefix('singLEFT', 'Crash Bro left', 24, false);
