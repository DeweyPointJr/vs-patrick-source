				...
				case 'airport':
					{
						camZoom = 0.9;
						curStage = 'airport';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('airport/stage'));
						bg.antialiasing = FlxG.save.data.antialiasing;
				...
				case 'plane':
					{
						camZoom = 0.9;
						curStage = 'plane';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('airport/plane'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
				...
				case 'crash':
					{
						camZoom = 0.9;
						curStage = 'crash';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('airport/crash'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
